...
module.exports = angular.module('spinnaker.core.help.contents', [])
  .constant('helpContents', {
    ...
    'gce.httpLoadBalancer.healthCheck.editExisting': 'Clicking <b>Delete</b> will not delete the specified health check; however, your changes will not be saved.',
    'gce.httpLoadBalancer.backendService.editExisting': 'Clicking <b>Delete</b> will not delete the specified backend service; however, your changes will not be saved.',
